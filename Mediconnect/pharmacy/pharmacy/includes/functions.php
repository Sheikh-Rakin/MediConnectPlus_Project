...
function add_cart($item_id)
{
    ...
    // Check if 'quantity' key is set in the $_GET array
    if (isset($_GET['quantity'])) {
        $quantity = $_GET['quantity'];
    } else {
        // Handle the case when 'quantity' is not provided in $_GET
        // You might want to set a default value or handle this situation in another way
        // For now, let's set a default value of 1
        $quantity = 1;
    }
