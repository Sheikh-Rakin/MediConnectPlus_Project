...
<body>
    ...
    <div class="container">
        <div class="menu">
             <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../img/mlogo.png" alt="" width="100%" style="border-radius:50%">
                                </td>
                ...
                <tr class="menu-row" >
                    ...
                    <td class="menu-btn menu-icon-home1 menu-active menu-icon-home1-active" >
                        <a href="../../home.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text"><strong>Home</strong></p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    
                    <td class="menu-btn menu-icon-home menu-active menu-icon-home-active" >
                        <a href="index.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dactor Appointment</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
        ...
        <div class="dash-body" style="margin-top: 100px">
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about doctors? no problem let's jumping to 
                                ...
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a>
                              <br>Also find out the expected arrival time of your doctor or medical consultant.<br>
                            </p>
