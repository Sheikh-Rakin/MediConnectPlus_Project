...
$sql = "SELECT * from tblblooddonars where ((status=:status and BloodGroup=:bloodgroup) && (status=:status and OrganType=:organtype)) ||  (Address=:location) ";
$query = $dbh -> prepare($sql);
