  ...
  if(isset($_POST['add_veh']))
    {
        ...
        $v_reg_no = isset($_POST['v_reg_no']) ? $_POST['v_reg_no'] : '';
        $v_category = isset($_POST['v_category']) ? $_POST['v_category'] : '';
        $v_pass_no = isset($_POST['v_pass_no']) ? $_POST['v_pass_no'] : '';
        $v_status = isset($_POST['v_status']) ? $_POST['v_status'] : '';
        $v_driver = isset($_POST['v_driver']) ? $_POST['v_driver'] : '';
        $v_dpic = isset($_FILES["v_dpic"]["name"]) ? $_FILES["v_dpic"]["name"] : '';        
         ...
         <div id="content-wrapper">
             ...
             <div class="container-fluid">
                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <form method="POST" enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                                 <label for="exampleInputEmail1">Ambulance Registration Number</label>
                ...
                ?>
                             ...
                             <!-- <div class="form-group">
                                 <label for="exampleFormControlSelect1">Ambulance Category</label>
                                 <select class="form-control" name="v_category" id="exampleFormControlSelect1">
                                     <option>Ambulance_Ac</option>
                                     <option>Ambulance_Non_Ac</option>
                                     <option>Ambulance_fridge</option>

                                 </select>
                             </div> -->

                             <div class="form-group">
                                 <label for="exampleFormControlSelect1">Ambulance Status</label>
                             ...
                             <div class="form-group col-md-12">
                                 <label for="exampleInputEmail1">Ambulance Picture</label>
                                 <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
                             </div>

                             <button type="submit" name="add_veh" class="btn btn-success">Add Ambulance</button>
                         </form>
                         <!-- End Form-->
                     </div>
                 </div>
